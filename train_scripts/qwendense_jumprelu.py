...
qwendense_model_name = "Qwen/Qwen3-32B"
qwendense_d_in = 5120
qwendense_d_sae = qwendense_d_in * 4
qwendense_hook_name = "model.layers.63.mlp"

model = load_model(model_name=qwendense_model_name, model_class_name = "AutoModelForCausalLM", device=device, model_from_pretrained_kwargs={"device_map": "auto"})
...
cfg = LanguageModelSAERunnerConfig(
    ...
    hook_name=qwendense_hook_name,  # A valid hook point (see more details here: https://neelnanda-io.github.io/TransformerLens/generated/demos/Main_Demo.html#Hook-Points)
    ...
    sae=JumpReLUTrainingSAEConfig(
        ...
        d_in=qwendense_d_in,  # the width of the mlp output.
        d_sae=qwendense_d_sae,  # the width of the SAE. Larger will result in better stats but slower training.
    ...
    seed=42,
    n_checkpoints=1,
    checkpoint_path="/root/nas/checkpoints/qwendense_jumprelu",
